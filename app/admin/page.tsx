        ...
        <div className="mx-auto max-w-4xl px-4 py-12">
          ...
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Button className="gap-2" onClick={() => {
              alert("In production, this would redirect to the GitHub App installation flow.")
            }}>
            ...
            <>
              ...
              {orgs.length === 0 ? (
                ...
                <div className="space-y-4">
                  ...
                  {orgs.map((org: { id: string; avatarUrl: string; name: string; githubOrgSlug: string; installedAt: string; isActive: boolean }) => (
                      ...
                      <CardContent>
                        <div className="flex items-center justify-between">
                          <p className="text-xs text-muted-foreground">
                            Installed {new Date(org.installedAt).toLocaleDateString("en-US", {
                              year: "numeric",
                              month: "long",
                              day: "numeric",
                            })}
