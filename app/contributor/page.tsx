        ...
        <div className="mx-auto max-w-4xl px-4 py-12">
          ...
          {isLoading ? (
            ...
            <>
              ...
              {/* Re-sign warning */}
              {outdatedCount > 0 && (
                <div className="mb-6 flex items-center gap-3 rounded-xl border border-amber-500/30 bg-amber-500/5 px-5 py-4" data-testid="resign-warning">
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <p className="max-w-sm text-sm text-muted-foreground">
                      When you open a pull request to a repository that uses CLA Bot,
                      you will be prompted to sign their CLA here.
                    </p>
                  </CardContent>
                </Card>
              ) : (
                      ...
                      <CardContent>
                        <div className="flex items-center justify-between">
                          ...
                          <Link href={`/sign/${sig.orgSlug}`}>
                            <Button variant={sig.isCurrentVersion ? "ghost" : "outline"} size="sm" className={`gap-2 ${sig.isCurrentVersion ? "text-muted-foreground" : "border-amber-500/30 text-amber-500 bg-transparent hover:bg-amber-500/10"}`}>
